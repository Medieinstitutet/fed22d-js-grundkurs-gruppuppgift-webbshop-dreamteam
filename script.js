...
<div class="controlsImgSlideshow" id="controlsImgSlideshow">
  ...
  function swapImages(e) {
    const donutcardImg1Slideshow = e.currentTarget.parentElement.parentElement.querySelector(
      "#donutImage1"
    );
    const donutCardImg2Slideshow = e.currentTarget.parentElement.parentElement.querySelector(
      "#donutImage2"
    );
...
function donutsOrderPrice() {
  ...
  const donutValue = donuts.reduce((previousValue, donut) => {
...
if (newDate.getMonth() === 11 && newDate.getDate() === 13) {
  document.querySelector(
    ".cartName"
  ).innerHTML += `<div> <span class="cartNameProduct">Produkt: Luciamunk <br></span> <span class="cartNameQuantity">Antal: 1</span> <span class="cartNamePrice">Pris: 0<br><hr></span></div>`;
}
